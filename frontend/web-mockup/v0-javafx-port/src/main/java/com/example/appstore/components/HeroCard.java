...
public class HeroCard extends VBox {
    ...
    public HeroCard(String title, String description, boolean isInstalled) {
        ...
        iconBox.setStyle("-fx-background-color: #27272a; -fx-background-radius: 10px;");
        ...
        if (isInstalled) {
            ...
            installBtn.setOnAction(e -> {
                ...
                pause.setOnFinished(ev -> {
                    ...
                    openBtn.setStyle("-fx-background-color: #27272a; -fx-text-fill: white; -fx-background-radius: 6px; -fx-font-weight: bold; -fx-cursor: hand; -fx-padding: 8 20; -fx-font-size: 13px;");
