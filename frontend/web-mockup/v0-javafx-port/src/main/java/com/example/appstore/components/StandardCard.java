...
public class StandardCard extends VBox {
    ...
    public StandardCard(String title, String vendor, String rating, String count, boolean isInstalled, Runnable onClick) {
        this.title = title;
        this.vendor = vendor;
        ...
        imageArea.setStyle("-fx-background-color: #27272a; -fx-background-radius: 12px 12px 0 0;");
        ...
        rateLabel.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 12px;");
        ...
        if (isInstalled) {
            ...
            installBtn.setOnAction(e -> {
                ...
                pause.setOnFinished(ev -> {
                    ...
                    openBtn.setStyle("-fx-background-color: #27272a; -fx-text-fill: white; -fx-background-radius: 6px; -fx-font-weight: bold; -fx-cursor: hand;");
                    openBtn.setOnAction(openEvent -> System.out.println("Opening " + title));
