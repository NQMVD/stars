...
public class TopBar extends HBox {
    ...
    private final java.util.List<Button> filterButtons = new java.util.ArrayList<>();

    public TopBar(java.util.function.Consumer<String> onSearch, java.util.function.Consumer<String> onFilter) {
        ...
        searchInput.setStyle("-fx-background-color: transparent; -fx-text-fill: white; -fx-prompt-text-fill: #71717a;");
        ...
        filters.setStyle("-fx-background-color: #18181b; -fx-background-radius: 6px; -fx-padding: 2;");
    ...
    private Button createFilterBtn(String text, boolean selected) {
        ...
        if (text.equals("Windows")) btn.setGraphic(new FontIcon(Feather.MONITOR));
    ...
    private void updateFilterBtnStyle(Button btn, boolean selected) {
        if (selected) {
            btn.setStyle("-fx-background-color: #27272a; -fx-text-fill: white;");
        } else {
            btn.setStyle("-fx-background-color: transparent; -fx-text-fill: #a1a1aa;");
        }
    }
}
