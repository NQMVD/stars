...
public class RootLayout extends BorderPane {
    ...
    public RootLayout() {
        ...
        // TopBar
        centerLayout.getChildren().add(new com.example.appstore.components.TopBar(
            query -> {
                if (currentSearchableView != null) currentSearchableView.onSearch(query);
            },
            platform -> {
                if (currentSearchableView != null) currentSearchableView.onFilter(platform);
            }
        ));
    ...
    public void showAppDetails(com.example.appstore.model.App app) {
        ...
        contentArea.getChildren().add(new com.example.appstore.views.AppDetailView(app, this::goBack));
